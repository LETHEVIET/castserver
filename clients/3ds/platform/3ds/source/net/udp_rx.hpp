...
// Packet header: magic(4) + frame_id(4) + chunk_id(2) + total_chunks(2)
#define UDP_MAGIC       0x33445331u
#define UDP_HDR_SIZE    12
...
// Returns pointer + size of the next complete Annex-B frame, or NULL if none.
